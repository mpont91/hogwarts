  ...
  <v-app>
    <v-container fluid class="pa-0 ma-0 background">
      <v-dialog
        ...
        persistent
      >
        <v-card v-if="!house && !currentQuestion">
          <v-card-title> Are you ready?</v-card-title>
          <v-card-actions>
            <v-btn @click="flow"> Begin</v-btn>
          </v-card-actions>
        </v-card>
        <v-card v-if="currentQuestion">
          <v-card-title> {{ currentQuestion.text }}</v-card-title>
          <v-card-actions>
            <v-btn
        ...
        <v-card v-if="house">
          <v-card-title> {{ house }}</v-card-title>
          <v-card-actions>
            <v-btn @click="restart"> Start again?</v-btn>
          </v-card-actions>
        </v-card>
      </v-dialog>
    </v-container>
